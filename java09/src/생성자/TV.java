...
public class TV {
	...
	// 객체생성할 때마다 꼭 실행시키고 싶은 내용이 있으면 기본 생성자를 눈에 보이게 만들어주세요. (명시적으로)
	// source->generate constructor
//	public TV(int ch, int vol, boolean onOff) { // 매개변수(parameter)
...
//
//	}
	// parameter 있는 생성자가 있을 때는 기본생성자가 자동생성되지 않음!
	// 생성자 또한 오버로딩 가능! (다중정의)
	...
	public void 유튜브를보다() { // 메서드를 만드는 것==> 메서드를 정의한다.
